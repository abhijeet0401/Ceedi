        ...
        acceptBtn.setOnClickListener {
            ...
            val stringRequest: StringRequest = object : StringRequest( Method.POST, "http://13.235.139.60/sandbox/bap/trigger/track",
                Response.Listener { response ->
                    ...
                    try {
                        Toast.makeText(baseContext,"successfully track call ",Toast.LENGTH_LONG).show()
        ...
        rejectBtn.setOnClickListener {
            ...
            val stringRequest: StringRequest = object : StringRequest( Method.POST, "http://13.235.139.60/sandbox/bap/trigger/cancel",
                Response.Listener { response ->
                    ...
                    try {
                        Toast.makeText(baseContext,"successfully cancel of order ",Toast.LENGTH_LONG).show()
                ...
                override fun getBody(): ByteArray {
                    ...
                    params2.put("use_case", "cancel/cancellation_of_an_order_with_reason_for_cancellation")
                    params2.put("ttl", "10")
                    params2.put("bpp_uri","http://13.235.139.60/sandbox/bpp1")
                    params2.put("transaction_id","123871371289371983")
                    return JSONObject(params2 as Map<*, *>).toString().toByteArray()
